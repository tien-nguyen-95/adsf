...
<div class="container-fluid">
    ...
    <!-- Page Heading -->
    <p class="mb-4">
        <a href="{{  route('productType.create')  }}" class="btn btn-primary">Thêm mới</a>
        <a href="{{  route('productType.trash')  }}" class="btn btn-secondary" style="float:right"><i class='fas fa-trash'></i> Thùng rác</a>
    </p>
    <!-- DataTales Example -->
                ...
                <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0"
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><a href="{{ route('productType.edit' , $productType->id) }}" class="btn btn-info btn-sm">
