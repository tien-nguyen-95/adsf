...
<div class="hero-wrap hero-bread" style="background-image: url('bakery/images/bg_bm1.jpg');">
  ...
  <section class="ftco-section ftco-no-pb ftco-no-pt bg-light">
          <div class="container">
              <div class="row">
                  <div class="col-md-5 p-md-5 img img-2 d-flex justify-content-center align-items-center" style="background-image: url(bakery/images/about.jpg);">
                      <a href="https://www.youtube.com/watch?v=N4DHaadHI0U" class="icon popup-vimeo d-flex justify-content-center align-items-center">
    ...
    <div class="container py-4">
      ...
      <section class="ftco-section ftco-counter img" id="section-counter" style="background-image: url(bakery/images/bg_3.jpg);">
      <div class="container">
